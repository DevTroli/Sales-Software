...
aplicar_desconto.short_description = "Aplicar 10%% de Desconto nos produtos selecionados"
...
class ProdutoAdmin(admin.ModelAdmin):
    ...
    actions = [aumentar_preco, aplicar_desconto, editar_produto_selecionado]  # Adiciona as ações personalizadas

    def get_urls(self):
        urls = super().get_urls()
        custom_urls = [
            path('editar_produto/<int:pk>/', self.admin_site.admin_view(self.editar_produto), name='editar_produto'),
        ]
    ...
    def editar_produto(self, request, pk):
        ...
        context = {
            ...
            'adminform': helpers.AdminForm(form, list([(None, {'fields': form.fields})]), {}),
            'is_popup': False,
            'save_on_top': False,
            'add': False,
            'change': True,
