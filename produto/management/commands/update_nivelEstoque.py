...
class Command(BaseCommand):
    help = 'Atualiza o nível de estoque de todos os produtos existentes no banco de dados.'

    def handle(self, *args, **kwargs):
        produtos = Produto.objects.all()
        total_produtos = produtos.count()
        self.stdout.write(self.style.NOTICE(f"Atualizando o nível de estoque para {total_produtos} produtos..."))
        ...
        self.stdout.write(self.style.SUCCESS(f"Atualização concluída! {atualizados} produtos atualizados."))